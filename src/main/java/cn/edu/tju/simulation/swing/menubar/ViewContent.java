...
import cn.edu.tju.simulation.SCS.paramaters.ContentWriter;
...
public class ViewContent extends JFrame{
	...
	public ViewContent(Container frame){
        ...
        this.mediaList = context.getOriginalContentList();
        initial();
        addListener();
        tableUpdate();
	}
	...
	public void initial(){
        ...
        try {
			...
			}
			{
				...
				sumOfSize = new JLabel("The sum of the paramaters sizes of all files : " + ContentService.unitConversion(sum)+" GB");
