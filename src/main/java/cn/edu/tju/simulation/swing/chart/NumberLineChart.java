...
//        xyitem.setBaseItemLabelFont(new Font("Dialog", 1, 12));
	...
	public XYSeriesCollection getCollection() {
		...
		HashMap<String,LinkedList<cn.edu.tju.simulation.SCS.RequestHandler.mydata>> ndMap = RequestHandler.ndMap;
...
//			series.add(0,0);
			LinkedList<cn.edu.tju.simulation.SCS.RequestHandler.mydata> mdList  = ndMap.get(key);
