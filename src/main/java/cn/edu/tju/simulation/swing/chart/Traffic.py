...
# DATA_FILE_PATH = str(sys.argv[0][0:sys.argv[0].index("\src")] + "main\resources\resultData\ResultData")
    ...
    for line in ResultData_Reader:
        if "Algorithm" in line.split(" ")[0]:
            ...
            for resultData in line_data:
                ...
                if len(resultData) == 4:
                    algorithm_data_list[-1].Data.append(float(resultData[3])/1024/1024)
