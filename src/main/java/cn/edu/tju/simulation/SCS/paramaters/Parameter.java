...
/**
 * Class of all parameters. This class corresponds to SIMULATION.xml, and each static attribute in the class corresponds to a key value in the paramaters.
 * You can also easily understand that the configuration paramaters is mapped to this class.
 * 
...
public class Parameter {
	/**
	 * Transmission delay from devices to base station
	 */
	...
	/**
	 * The probability that a devices will generate a request at a time slice.
	 */
	...
	/**
	 * The minimum value of the default devices's fluctuation range.
	 */
	public static float UserMinWaveInterval;
	/**
	 * The maximum value of the default devices's fluctuation range.
	 */
