...
/**
 * Open the case paramaters. The case paramaters is used to record the configuration of the network system.
...
public class CaseFileReader {
	...
	public Boolean read(Context context, File file){
			...
			try {
				while ((line = bufferedReader.readLine()) != null) {
					if(line.equals("#WirelessNetwork")){
						...
						context.getWirelessNetworkGroup().BS.addWirelessNetwork(StringHandler.readBS(line));
						continue;
