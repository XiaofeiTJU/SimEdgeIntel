...
public abstract class Cache {
	...
	/**
	 * A list of contents in the cache, each cached files is an object that
	 * contains the following properties: files; Status (being downloaded or
	 ...
	 * the requested files, or false if not included. This method specifically
	 * refers to the devices directly query the base station.
	 */
