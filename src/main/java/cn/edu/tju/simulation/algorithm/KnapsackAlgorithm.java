...
//				context.appendLog("debug","The maximum cache popularity£º " + maxPopularity+"  Cached files number£º",null);
//				for(int n = 0 ; n<network.getCacheContent().size();n++){
//					context.appendLog("debug",network.getCacheContent().get(n).getName()+"",null);
//				}	
			} else {
	 ...
	 *            Cache size
	 * @param media_sizes
	 *            A collection of all files sizes
	 * @param media_amounts
	 *            Collection of all files downloads (popularity)
	 * @return
	 */
